...
struct graph
{
    ...
    vector<pair<long, pair<long, long>>> edgeList2;
    stack<pair<long, pair<long, long>>> temp;
    ...
    void kruskal(vector<pair<long, pair<long, long>>> &result)
    {
        ...
        // edgeList.
        sort(edgeList.begin(), edgeList.end(), greater<pair<long, pair<long, long>>>());
