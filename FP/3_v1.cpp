...
int main(int argc, char const *argv[])
{
    ...
    {
        cin >> input_num;
        // cout << i + 1 << " " << (loop / 2) << " " << input_num << endl;
        ...
        {
            slist_pushBack(&secList, input_num);
        }
    }
    ...
    // // posisi ganjil
    // while (secList._head != NULL)
    // {
    //     printf("%d ", slist_front(&secList));
    //     slist_popFront(&secList);
    // }

    while (secList._head != NULL && myList._head != NULL)
    {
        if (secList._head != NULL)
        {
            printf("%d ", slist_front(&secList));
            slist_popFront(&secList);
        }
